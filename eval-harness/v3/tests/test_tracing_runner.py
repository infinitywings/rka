...
ANCHOR = "dec_01SCAFFOLDCHOICE00000000"
DIRECTIVE = "jrn_01PIDIRECTIVE0000000000"
EVIDENCE = "clm_01CONTAMINATION00000000"
PAPER = "lit_01SWEBENCHPAPER00000000"
    ...
    def handler(request: httpx.Request) -> httpx.Response:
        ...
        if path == "/api/search":
            return httpx.Response(
                200, json=[{"id": "dec_01OTHERDECISION000000000"}, {"id": ANCHOR}]
            )
