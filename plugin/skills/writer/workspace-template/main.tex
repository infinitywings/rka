...
\title{REPLACE_WITH_MANUSCRIPT_TITLE_LATEX}
\author{}
\date{\today}
\maketitle

\begin{abstract}
% Abstract prose is added after PRECIS ratification. Every substantive block
% must then be preceded by a valid RKA provenance marker.
\end{abstract}
