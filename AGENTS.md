# AGENTS.md — RKA Codebase (Executor instructions)
...
Codex Desktop/Code needs a local stdio process. It proxies all calls to the
...
`~/Library/Application Support/Codex/claude_desktop_config.json`:
```json
