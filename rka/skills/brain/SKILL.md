...
|---|---|
| `rka_query(args)` | All 60 read operations (status, context, journal, research map, planning branches, claim scope, experiments, native manuscripts, change impact, etc.) |
| `rka_execute(args)` | All 72 write/lifecycle operations (notes, decisions, missions, planning artifacts, interpretation promotion, experiment evidence, claim-scope review, manuscripts, checkpoints, maintenance) |
...
rka_describe(operation="")                 # compact index of all 132 ops
```
