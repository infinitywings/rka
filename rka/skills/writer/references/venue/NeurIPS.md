...
> Auto-generated from `NeurIPS.yaml` by `venue_md_generator.py`. Do NOT edit the auto-generated region by hand - re-run the generator. Add freeform notes to `NeurIPS.notes.md`; they will be appended.
...
|---|---|---|
| warn | `we propose a novel` | extremely overused at NeurIPS; reviewers flag |
| warn | `state-of-the-art` | requires head-to-head comparison + dataset + metric specification |
| warn | `robust` | requires operational definition (e.g., 'robust under L_inf <= 0.03') |
...
- Diversity topics:
  ...
  - datasets
  - evaluation
- RKA tag for ingested samples: `venue-sample:NeurIPS`.
...
- Template registry key: `neurips_official` (see `references/template_registry.md`).
- Default engine: `pdflatex`.
- Other supported engines: lualatex, xelatex.

## References (CFP + author guides)

- Primary CFP: https://neurips.cc/Conferences/2025/CallForPapers
- Author guide: https://neurips.cc/Conferences/2025/AuthorInformation
- Checklist / extras: https://neurips.cc/public/guides/PaperChecklist
