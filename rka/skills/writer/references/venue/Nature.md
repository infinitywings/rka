...
> Auto-generated from `Nature.yaml` by `venue_md_generator.py`. Do NOT edit the auto-generated region by hand - re-run the generator. Add freeform notes to `Nature.notes.md`; they will be appended.
...
**Typical appendix contents:**
  ...
  - Extended Data figures (up to 10)
  - Extended Data tables (up to 10)
  - Supplementary Information PDF
  - Reporting Standard checklists (CONSORT / STROBE / PRISMA)
...
|---|---|---|
| warn | `we propose a novel` | overused; flagged given Nature's narrative-first emphasis |
| warn | `groundbreaking` | Nature's editors strip marketing language in editing |
| warn | `paradigm-shifting` | Nature's editors strip marketing language in editing |
| warn | `it is important to note` | Nature's word budget makes empty connectives costly |
| warn | `comprehensive` | vague hedge against scope criticism; specify the scope |
...
Abstract: target **175 words** (typical range: 150 to 200 words).
...
- Diversity topics:
  - subfield_specific
- RKA tag for ingested samples: `venue-sample:Nature`.
...
| novelty | high |
| cross_discipline_accessibility | high |
| methodological_rigor | high |
| data_and_code_availability | high |

## Template notes

- Template registry key: `nature_official` (see `references/template_registry.md`).
- Default engine: `pdflatex`.
- Other supported engines: lualatex, xelatex.

## References (CFP + author guides)

- Primary CFP: https://www.nature.com/nature/for-authors/initial-submission
- Author guide: https://www.nature.com/nature/for-authors
- Checklist / extras: https://www.nature.com/nature-portfolio/editorial-policies/reporting-standards
