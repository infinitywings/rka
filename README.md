...
| Tool             | Purpose                                                                                                                |
| ---------------- | ---------------------------------------------------------------------------------------------------------------------- |
| `rka_query`      | Dispatcher for **42 read operations** (`status`, `search`, `research_map`, `list_projects`, `context`, …) — call with `operation="…"` plus the operation's typed args. |
